...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/home/zhangbin/xlive/encRecord/out --enable-gpl --enable-version3 --arch=arm --enable-cross-compile --cross-prefix=arm-hisiv100nptl-linux- --host-cc=gcc --target-os=linux --enable-static --disable-asm --disable-programs --disable-doc --disable-avdevice --disable-swresample --disable-swscale --disable-postproc --disable-avfilter --disable-everything --enable-muxer=flv --enable-muxer=mpegts --enable-muxer=h264 --disable-dct --disable-dwt --disable-error-resilience --disable-lsp --disable-lzo --disable-mdct --disable-rdft --disable-fft --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --enable-muxer=hls --enable-muxer=rtp --enable-muxer=rtsp --enable-protocol=file --enable-protocol=rtmp --enable-protocol=http --enable-protocol=rtmpe --enable-protocol=rtmps --enable-protocol=rtmpt --enable-protocol=rtmpte --enable-protocol=rtmpts --enable-protocol=tcp --enable-protocol=udp --enable-protocol=ffrtmpcrypt --enable-protocol=ffrtmphttp --enable-network
...
CC_IDENT=gcc 4.4.1 (Hisilicon_v100(gcc4.4-290+uclibc_0.9.32.1+eabi+linuxpthread)
ARCH=c
CC=arm-hisiv100nptl-linux-gcc
CXX=arm-hisiv100nptl-linux-g++
AS=arm-hisiv100nptl-linux-gcc
LD=arm-hisiv100nptl-linux-gcc
DEPCC=arm-hisiv100nptl-linux-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=arm-hisiv100nptl-linux-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
CFLAGS=   -march=armv5te -std=c99 -fomit-frame-pointer -marm -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=   -march=armv5te -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=arm-hisiv100nptl-linux-windres
DEPWINDRES=arm-hisiv100nptl-linux-gcc
DOXYGEN=doxygen
